...
const filterProducts = productsTask4.filter((item) => item.photos && item["photos"].length !== 0);
console.log("Фильтр по фото");
console.log(filterProducts);

// 2

const sortProducts = productsTask4.sort((item1, item2) => item1.price - item2.price);
